...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-800 md:mx-10'>
        ...
        <button onClick={()=>{navigate("/doctors"); scrollTo(0,0)}} className='text-gray-600 bg-gray-100 px-12 py-3 rounded-full mt-10 cursor-pointer hover:bg-gray-200'>more</button>
    </div>
  )
}
